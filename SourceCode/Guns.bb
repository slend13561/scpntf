	...
	If playerAlive Then
		For g = Each Guns
			...
			If g\ID = pHoldingGun Then
				shootCondition = ((Not MenuOpen) And (Not ConsoleOpen) And ((Not isMultiplayer) Lor (Not InLobby()) And (Not mp_I\ChatOpen) And (Not mp_I\Gamemode\DisableMovement)) And (Not IsPlayerListOpen()) And (Not IsModerationOpen()))
				Select g\GunType
					Case GUNTYPE_AUTO
						;[Block]
						If pAmmo=0 Then
...
;~F#8#50#66#A9#B0#167#1B5#1CE#630#678#6BF#6E7#731#7DE#831#85C#874#8B9#8C6#8E9
;~F#8FE#90A
