...
;	Next
	...
	If mp_O\LocalServer=False Then
		AddServer(VersionNumber, Steam_GetPlayerIDLower(), Steam_GetPlayerIDUpper(), Steam_GetIPCountry(), mp_I\ServerName, (mp_O\Password<>""), mp_O\Gamemode\ID, mp_O\MapInList\Name, mp_I\PlayerCount, mp_O\MaxPlayers)
