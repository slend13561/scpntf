						...
						Else
							...
							If roundEnd Then
								If (mp_I\Gamemode\RoundWins[Team_MTF-1] >= 16 Lor mp_I\Gamemode\RoundWins[Team_CI-1] >= 16) Then
									mp_I\Gamemode\Phase = Deathmatch_End
									mp_I\Gamemode\PhaseTimer = 70*10
								Else	
									mp_I\Gamemode\PhaseTimer = 70*5
								EndIf	
...
;~F#27#3A#48#58#5C#96#B6#CA#F6#14C#15D#1A8#1BA#205#284#2C2#2D1#2D8#2FB#343
;~F#34D#367#385#38E#399#3A5#3AC#3B9#3C8#3D1#3F4#417#422#457#477#491#49B#4AA#4FA#501
;~F#50E#545
;~C#Blitz3D