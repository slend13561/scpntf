...
Function FillRoom_Checkpoint_EZ(r.Rooms)
	...
	For i = 0 To 1
		FreeEntity r\RoomDoors[CHECKPOINT_AIRLOCK_DOOR1_ID]\buttons[i] : r\RoomDoors[CHECKPOINT_AIRLOCK_DOOR1_ID]\buttons[i] = 0
		FreeEntity r\RoomDoors[CHECKPOINT_AIRLOCK_DOOR2_ID]\buttons[i] : r\RoomDoors[CHECKPOINT_AIRLOCK_DOOR2_ID]\buttons[i] = 0
	Next
	...
	If PlayerRoom = e\room Then
		...
		Select e\EventState
			Case 0 ;Room hasn't been entered before
				...
				If e\room\NPC[CHECKPOINT_EZ_NPC1_ID] <> Null And e\room\NPC[CHECKPOINT_EZ_NPC2_ID] <> Null Then
					...
					PlayNewDialogue(100,%1110011101)
					mtfd\Enabled = False
		...
		If e\EventState3 = 2 Then
			...
			If AnimTime(e\room\NPC[CHECKPOINT_EZ_NPC1_ID]\obj) >= 2055 Then
				Curr106\Idle = False
				Curr106\State = -10
				If (Not EntityHidden(e\room\NPC[CHECKPOINT_EZ_NPC1_ID]\obj)) Then
					PlaySound_Strict LoadTempSound("SFX\General\WaveStart.ogg")
				EndIf	
				HideEntity e\room\NPC[CHECKPOINT_EZ_NPC1_ID]\obj
				EntityType e\room\NPC[CHECKPOINT_EZ_NPC1_ID]\Collider, HIT_DEAD
				HideEntity e\room\NPC[CHECKPOINT_EZ_NPC2_ID]\obj
				EntityType e\room\NPC[CHECKPOINT_EZ_NPC2_ID]\Collider, HIT_DEAD
				e\EventState3 = 3
			Else
