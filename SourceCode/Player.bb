...
Function UpdateCommunicationAndSocialWheel()
	...
	If ((NTF_GameModeFlag = 3 And (Not InLobby()) And (Not mp_I\ChatOpen) And (Not IsSpectator(mp_I\PlayerID)) And Players[mp_I\PlayerID]\CurrHP > 0) Lor (NTF_GameModeFlag <> 3 And EndingTimer >= 0 And KillTimer >= 0 And (Not InvOpen) And (Not MenuOpen))) And (Not ConsoleOpen) And (Not IsModerationOpen()) Then
